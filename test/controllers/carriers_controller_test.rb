...
class CarriersControllerTest < ActionController::TestCase
  ...
  test "should create carrier" do
    assert_difference('Carrier.count') do
      post :create, carrier: { is_customer: @carrier.is_customer, is_supplier: @carrier.is_supplier, name: @carrier.name }
    end
  ...
  test "should update carrier" do
    patch :update, id: @carrier, carrier: { is_customer: @carrier.is_customer, is_supplier: @carrier.is_supplier, name: @carrier.name }
    assert_redirected_to carrier_path(assigns(:carrier))
  end
